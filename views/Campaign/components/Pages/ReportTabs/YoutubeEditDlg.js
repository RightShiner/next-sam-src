...
import { ReportYoutubeEditTable } from '../../Table';
...
const YoutubeEditDlg = ({
  ...
  const saveUpdatedData = () => {
    ...
    return campaignService
      .updateReportYoutube(selCampId, updatedRecords)
      .then((ret) => {
        if (ret.status !== 'ok') {
