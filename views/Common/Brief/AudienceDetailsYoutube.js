...
const lang = {
  en: {
    subscriberAnalysis: 'Subscriber analysis',
    subscriberAnalysisInfo: 'For more information, please see "Full Report".',
    ...
    language: 'Language',
    languageInfo: 'Language used by the registrant. ',
    similar: 'Similar account',
    similarInfo: 'Accounts with similar followers',
  },
  jp: {
    subscriberAnalysis: '登録者分析',
    subscriberAnalysisInfo:
      'もっと詳しく知りたい場合は「フルレポート」をご覧ください。',
    celebrityRate: '有名人率',
    celebrityRateInfo: '登録者数1000人以上のアカウントが登録している率です。',
    genderRatio: '男女比',
    genderRatioInfo: '登録者の男女比',
    male: '男',
    female: '女',
    country: '国',
    countryInfo: '登録者がどこの国にいつのか。',
    genderAgeRatio: '年代別男女比',
    genderAgeRatioInfo: '登録者の年代別男女比',
    language: '言語',
    languageInfo: '登録者の使っている言語。',
    similar: '類似アカウント',
    similarInfo: 'キーワードトピックから類似アカウントを表示しています。',
  },
};
  ...
  return (
    <Box className="audiencedetails">
      <Box sx={{ display: 'flex', alignItems: 'center' }}>
        ...
        <span>{lang[locale].subscriberAnalysis}</span>
        <RoundInfo
          sx={{ marginLeft: '.5rem' }}
          caption={lang[locale].subscriberAnalysisInfo}
        />
      </Box>
      <Box className="wrapper-grid" sx={{ gridTemplateColumns: '1fr 1fr' }}>
        ...
        <Box className="box-wrapper-shadow grid-item">
          ...
          >
            ...
            <RoundInfo
              sx={{ marginLeft: '.5rem' }}
              caption={lang[locale].languageInfo}
            />
          </Box>
          {_.map(
            data.languages,
