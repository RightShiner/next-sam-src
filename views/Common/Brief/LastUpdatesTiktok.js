    ...
    <Box className="lastupdates">
      <Box className="wrapper-grid" sx={{ gridTemplateColumns: '1fr 1fr' }}>
        ...
        >
          ...
          <Box className="subtitle">{evaluateValue(data.avgViews)}</Box>
        ...
        >
          ...
          <Box className="subtitle">{evaluateValue(data.avgLikes)}</Box>
...
export default LastUpdatesTiktok;
